module.exports = class Data1736607269486 {
    name = 'Data1736607269486'

    async up(db) {
        await db.query(`CREATE TABLE "unipool" ("id" character varying NOT NULL, "chain" text NOT NULL, "address" text NOT NULL, "name" text, "total_notified" numeric NOT NULL, "total_assigned_to" numeric NOT NULL, CONSTRAINT "PK_293c9f4a9d07e4c94dc2e1a9a3d" PRIMARY KEY ("id"))`)
